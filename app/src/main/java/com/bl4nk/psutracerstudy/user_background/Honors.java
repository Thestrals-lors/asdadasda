...
public class Honors extends Fragment {


    private TextView countAcademicDistinctionTextView;
    private TextView countSummaCumLaudeTextView;
    private TextView countMagnaCumLaudeTextView;
    private TextView countCumLaudeTextView;
    private TextView countNoneTextView;
    private TextView countOtherTextView;

    private PieChart honorsPieChart;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_honors, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        countAcademicDistinctionTextView = view.findViewById(R.id.countAcademicDistinctionTextView);
        countSummaCumLaudeTextView = view.findViewById(R.id.countSummaCumLaudeTextView);
        countMagnaCumLaudeTextView = view.findViewById(R.id.countMagnaCumLaudeTextView);
        countCumLaudeTextView = view.findViewById(R.id.countCumLaudeTextView);
        countNoneTextView = view.findViewById(R.id.countNoneTextView);
        countOtherTextView = view.findViewById(R.id.countOtherTextView);

        honorsPieChart = view.findViewById(R.id.honorsPieChart);
        ...
        allTasks.addOnCompleteListener(new OnCompleteListener<List<QuerySnapshot>>() {
            ...
            public void onComplete(@NonNull Task<List<QuerySnapshot>> task) {
                if (task.isSuccessful()) {
                    ...
                    countAcademicDistinctionTextView.setText(String.valueOf(countAcademicDistinction));
                    countSummaCumLaudeTextView.setText(String.valueOf(countSummaCumLaude));
                    countMagnaCumLaudeTextView.setText(String.valueOf(countMagnaCumLaude));
                    countCumLaudeTextView.setText(String.valueOf(countCumLaude));
    ...
    private void setupPieChart(ArrayList<PieEntry> entries) {
        ...
        honorsPieChart.setData(pieData);

        honorsPieChart.setHoleRadius(0f);
        pieDataSet.setSliceSpace(0f);

        Legend legend = honorsPieChart.getLegend();
        legend.setVerticalAlignment(Legend.LegendVerticalAlignment.TOP);
        legend.setHorizontalAlignment(Legend.LegendHorizontalAlignment.LEFT);
        legend.setOrientation(Legend.LegendOrientation.VERTICAL);
        legend.setEnabled(false);

        honorsPieChart.getDescription().setEnabled(false);
        honorsPieChart.animateY(1000);

//        questionPieChart.setExtraOffsets(30f, 0f, 0f, 0f);

        honorsPieChart.invalidate();
    }
}