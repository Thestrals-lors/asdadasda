...
public class Question9 extends Fragment {
    ...
    public static Question9 newInstance(String param1, String param2) {
        Question9 fragment = new Question9();
...
// Tasks to fetch data from Firestore
        Task<QuerySnapshot> yesTask = fStore.collection("SurveyAnswer").whereEqualTo("question9", "Yes").get();
        Task<QuerySnapshot> noTask = fStore.collection("SurveyAnswer").whereEqualTo("question9", "No").get();
