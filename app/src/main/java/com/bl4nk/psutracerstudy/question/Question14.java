...
public class Question14 extends Fragment {
    ...
    private TextView countLessThanMonthTextView;
    private TextView count1To6MonthsTextView;
    private TextView count7To11MonthsTextView;
    private TextView count1To2YearsTextView;
    private TextView count2To3YearsTextView;
    private TextView count3To4YearsTextView;
    ...
    public static Question14 newInstance(String param1, String param2) {
        Question14 fragment = new Question14();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Task<QuerySnapshot> lessThanMonthTask = fStore.collection("SurveyAnswer").whereEqualTo("question14", "Less than a month").get();
        Task<QuerySnapshot> oneToSixMonthsTask = fStore.collection("SurveyAnswer").whereEqualTo("question14", "1-6 months").get();
        Task<QuerySnapshot> sevenToElevenMonthsTask = fStore.collection("SurveyAnswer").whereEqualTo("question14", "7-11 months").get();
        Task<QuerySnapshot> oneToTwoYearsTask = fStore.collection("SurveyAnswer").whereEqualTo("question14", "1 year to less than 2 years").get();
        Task<QuerySnapshot> twoToThreeYearsTask = fStore.collection("SurveyAnswer").whereEqualTo("question14", "2 years to less than 3 years").get();
        Task<QuerySnapshot> threeToFourYearsTask = fStore.collection("SurveyAnswer").whereEqualTo("question14", "3 years to less than 4 years").get();
        Task<QuerySnapshot> otherTask = fStore.collection("SurveyAnswer").whereEqualTo("question14", "Other:").get();
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                // Check if the value of "question14" contains "Other"
                                String questionValue = document.getString("question14");
