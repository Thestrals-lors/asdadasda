...
public class Question11 extends Fragment {
    ...
    private TextView countSalariesAndBenefitsTextView;
    private TextView countCareerChallengeTextView;
    private TextView countRelatedToCourseTextView;
    private TextView countProximityTextView;
    private TextView countGoodRelationsTextView;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Task<QuerySnapshot> relationsTask = fStore.collection("SurveyAnswer").whereArrayContains("question10", "Relations with people in the organization").get();
        ...
        fStore.collection("SurveyAnswer").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
                    ...
                    allTasks.addOnCompleteListener(new OnCompleteListener<List<QuerySnapshot>>() {
                        ...
                        public void onComplete(@NonNull Task<List<QuerySnapshot>> task) {
                            if (task.isSuccessful()) {
                                ...
                                float percentageRelations = ((float) countRelations / totalCount) * 100;
                                float percentageOther = ((float) countOther / totalCount) * 100;

                                countSalariesAndBenefitsTextView.setText(String.valueOf(countSalariesBenefits));
                                countCareerChallengeTextView.setText(String.valueOf(countCareerChallenge));
                                countRelatedToCourseTextView.setText(String.valueOf(countRelatedToSpecialSkills));
                                countProximityTextView.setText(String.valueOf(countProximityToResidence));
                                countGoodRelationsTextView.setText(String.valueOf(countRelations));
                                ...
                                entries.add(new PieEntry(percentageRelations, "Relations with people in the organization"));
