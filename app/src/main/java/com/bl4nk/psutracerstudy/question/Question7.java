...
// Tasks to fetch data from Firestore
        Task<QuerySnapshot> yesTask = fStore.collection("SurveyAnswer").whereEqualTo("question7", "Yes").get();
        Task<QuerySnapshot> noTask = fStore.collection("SurveyAnswer").whereEqualTo("question7", "No").get();
